...
* 4. [telegraf configuration](#telegrafconfiguration)
	...
	* 4.2. [tags](#tags)
	* 4.3. [importing demo app](#importingdemoapp)
	* 4.4. [build a hierarchy](#buildahierarchy)
		* 4.4.1. [Custom hierarchy by component tag](#Customhierarchybycomponenttag)
		* 4.4.2. [Custom hierarchy by business tags: service/environment/component](#Customhierarchybybusinesstags:serviceenvironmentcomponent)
	* 4.5. [Stack Linking](#StackLinking)
		* 4.5.1. [stack linking to entities](#stacklinkingtoentities)
		* 4.5.2. [stack linking to higher level nodes such as environment.](#stacklinkingtohigherlevelnodessuchasenvironment.)
* 5. [Integrating Existing Content Into the New Hierarchy Tree](#IntegratingExistingContentIntotheNewHierarchyTree)
	* 5.1. [Walkthrough - convert the redis overview dasbhoard to work with the new hierarchy](#Walkthrough-converttheredisoverviewdasbhoardtoworkwiththenewhierarchy)
		* 5.1.1. [fix up the stack linking.](#fixupthestacklinking.)
	* 5.2. [Creating a redis _sourcehost node dashboard](#Creatingaredis_sourcehostnodedashboard)
...
###  4.3. <a name='importingdemoapp'></a>importing demo app
...
###  4.4. <a name='buildahierarchy'></a>build a hierarchy 
...
####  4.4.1. <a name='Customhierarchybycomponenttag'></a>Custom hierarchy by component tag
...
####  4.4.2. <a name='Customhierarchybybusinesstags:serviceenvironmentcomponent'></a>Custom hierarchy by business tags: service/environment/component
...
###  4.5. <a name='StackLinking'></a>Stack Linking 
...
####  4.5.1. <a name='stacklinkingtoentities'></a>stack linking to entities
...
####  4.5.2. <a name='stacklinkingtohigherlevelnodessuchasenvironment.'></a>stack linking to higher level nodes such as environment.
...
##  5. <a name='IntegratingExistingContentIntotheNewHierarchyTree'></a>Integrating Existing Content Into the New Hierarchy Tree
...
###  5.1. <a name='Walkthrough-converttheredisoverviewdasbhoardtoworkwiththenewhierarchy'></a>Walkthrough - convert the redis overview dasbhoard to work with the new hierarchy
...
####  5.1.1. <a name='fixupthestacklinking.'></a>fix up the stack linking.
...
###  5.2. <a name='Creatingaredis_sourcehostnodedashboard'></a>Creating a redis _sourcehost node dashboard
